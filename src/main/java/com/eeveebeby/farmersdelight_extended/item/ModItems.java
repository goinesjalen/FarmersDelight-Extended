...
public class ModItems {
    ...
    public static final DeferredItem<Item> FISH_AND_CHIPS = ITEMS.register("fish_and_chips",
            () -> new Item(new Item.Properties().food(ModFoodProperties.FISH_AND_CHIPS).stacksTo(16)
    ...
    public static final DeferredItem<Item> CHICKEN_AND_FRIES = ITEMS.register("chicken_and_fries",
            () -> new Item(new Item.Properties().food(ModFoodProperties.CHICKEN_AND_FRIES).stacksTo(16)
                    .craftRemainder(Items.BOWL)));
    ...
    public static final DeferredItem<Item> CHICKEN_PARMESAN = ITEMS.register("chicken_parmesan",
            () -> new Item(new Item.Properties().food(ModFoodProperties.CHICKEN_PARMESAN).stacksTo(16)
                    .craftRemainder(Items.BOWL)));
    public static final DeferredItem<Item> BEEF_WELLINGTON = ITEMS.register("beef_wellington",
            () -> new Item(new Item.Properties().food(ModFoodProperties.BEEF_WELLINGTON).stacksTo(16)
                    .craftRemainder(Items.BOWL)));
    ...
    public static final DeferredItem<Item> SPICY_CHICKEN_AND_FRIES = ITEMS.register("spicy_chicken_and_fries",
            () -> new SpicyFriedChickenItem(new Item.Properties().food(ModFoodProperties.SPICY_CHICKEN_AND_FRIES)
    ...
    public static final DeferredItem<Item> BREAKFAST_PLATE = ITEMS.register("breakfast_plate",
            () -> new Item(new Item.Properties().food(ModFoodProperties.BREAKFAST_PLATE).stacksTo(16)
                    .craftRemainder(Items.BOWL)));

    // Group 4
    public static final DeferredItem<Item> GOLDEN_APPLE_CIDER = ITEMS.register("golden_apple_cider",
            () -> new DrinkableItem(new Item.Properties().food(ModFoodProperties.GOLDEN_APPLE_CIDER).stacksTo(16)
                    .craftRemainder(Items.GLASS_BOTTLE), true, false));
    ...
    public static final DeferredItem<Item> RICE_FLOUR = ITEMS.register("rice_flour",
            () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> RICE_DOUGH = ITEMS.register("rice_dough",
            () -> new Item(new Item.Properties().food(ModFoodProperties.RICE_DOUGH)));
